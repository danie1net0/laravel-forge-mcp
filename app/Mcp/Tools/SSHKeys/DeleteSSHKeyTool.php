...
#[IsDestructive]
class DeleteSSHKeyTool extends Tool
{
    protected string $description = 'Delete an SSH key from a Forge server.';
    ...
    public function handle(Request $request, ForgeClient $client): Response
    {
        ...
        try {
            $client->sshKeys()->delete($serverId, $keyId);

            return Response::text(json_encode([
                'success' => true,
                'message' => "SSH key #{$keyId} deleted successfully",
            ], JSON_PRETTY_PRINT));
        } catch (Exception $e) {
